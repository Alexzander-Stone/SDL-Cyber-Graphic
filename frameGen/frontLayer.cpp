...
// Constructors
FrontLayer::FrontLayer(SDL_Renderer* totalRenderer) 
    : renderer(totalRenderer)
{
    std::cout << "Front layer created (passed renderer)" << std::endl;
}


void FrontLayer::draw()
{
    std::cout << "Begin drawing front layer" << std::endl;
    ...
    SDL_SetRenderDrawColor( renderer, 0, 255, 0, 255/4 ); 
